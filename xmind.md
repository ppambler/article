...
- 如何构建结构？
  - 自上而下
    - 场景：明确知道要解决的问题是什么、有一个非常明确的目标，如求职
    - 思考框架
      - 2W1H
        - 构建结构最常用，也是最有用的框架之一，因为它涉及到一个问题的最核心的 3 个要素
        - What 是定义问题、Why 是分析问题、How 是解决问题
        - 2W1H 实际上是对 5W2H（Why、Who、When、Where、What、How 和 How much）的简化和提炼
        - 如果需要更加全面的思考，我们需要尽量满足 MECE 法则，此时，5W2H 可能是更好的选择
      - 5Why 分析法
        - 通过疑问解答这中方式，可以帮助我们更加深入的理解问题
        - 对于大部分的问题，如果你能连续追问 5 个 why（为什么），一般都能触及问题的本质，也就是找到问题的真正原因和解决的方法
  - 自下而上
    - 场景：要解决的问题并没有那么明确，或者面对的是一堆零散的元素，如头脑风暴时，产出了很多想法，我们要如何整理这些想法，此时，我们要如何构建清晰的结构呢？
    - 常用方法
      - 归纳整理法，面对散乱的素材归纳整理后，构建出一个更加清晰的结构
  - 上下结合（常用）
    - 是什么
      - 自上而下的分解，自下而上的归纳，二者不是你有我无的关系
      - 构建结构的过程是上上下下，来来回回，反复修改，反复优化的过程
      - 演绎法和归纳法的完美结合
    - 场景：自上而下分解业务逻辑，自下而上提取代码，提升代码复用性和扩展性
- 更多有用的结构？
  - 5W2H
    - Why（目的或为什么）、Who（谁来执行）、When（时间）、Where（地点）、What（是什么）、How（如何做） 和 How much（目标）
    - 很多问题都可以拆解成这 7 个要素，如果你知晓这个结构，在分析问题的时候，就比不知道这个结构的人要更加全面和体系化
  - 制定市场营销策略的“4P”模型
    - 产品策略（Product Strategy）、价格策略（Price Strategy）、渠道策略（Place Strategy）、促销策略（Promotion Strategy）
  - 思考组织战略的“7S”模型
    - 经营策略（Strategy）、组织结构（Structure）、运营系统（System）、经营风格（Style）、职员（Staff）、组织技能（Skill）和共享价值观（Shared value）
  - 分析竞争力的 SWOT 模型
    - SWOT 分析代表分析企业优势（Strengths）、劣势（Weakness）、机会（Opportunity）和威胁（Threats
  - 制定目标的 SMART 模型
    - 制定目标要满足确定性（Specific) 、可度量性（Measurable）、可实现性（Attainable）、相关性（Relevant）和时效性（Time-based）
  - Zoom in/Zoom out（本是摄像术语，可引申为 总分总）
  - PDCA（Plan、DO、Check 和 Action）
  - 麦肯锡推荐的问题解决框架
    - 提出问题，定义问题，分析问题，解决问题，展望未来
  - **以上是一些思考框架，用这些框架的目的是极大的提升我们解决问题的效率，同时帮助我们做更加全面的、结构化的思考。做到“无遗漏，不重复”**
- 💡：Q&A
  - 什么是「万物之本」？
    - 万物的源头，有人说水是万物之本
    - 夫虚静恬淡寂漠无为者，万物之本也
  ...
  - 多分法？
    - 元素周期表：列是属性，行是属性水平 -> 类似表格
    - [分类和本质 - 知乎](https://zhuanlan.zhihu.com/p/391970451)
    - [多分法看事，多维度看人 - 知乎](https://zhuanlan.zhihu.com/p/39723874)
  - 什么是模型？
    - 模型是指对于某个实际问题或客观事物、规律进行抽象后的一种形式化表达方式
    - 它的重点是「抽象」 -> 模型是可以简化人们的认知成本，有助于人们拨开庞杂细节和迷雾，理解客观事物的
    - 例子
      - 5W2H
      - [麦肯锡“七步成诗法”，也叫解决问题的七个步骤](https://zhuanlan.zhihu.com/p/104863135)
        - [wiki](https://wiki.mbalib.com/wiki/%E9%BA%A6%E8%82%AF%E9%94%A1%E4%B8%83%E6%AD%A5%E6%88%90%E8%AF%97%E6%B3%95)
    - [人们谈论的「模型」究竟是什么？](http://www.woshipm.com/it/3365994.html)
    - [初级问题，什么是建模？？-CSDN 社区](https://bbs.csdn.net/topics/60424788)
    - 
- 待阅读文章
  - 一文教会你如何写复杂业务代码
